...
namespace DioImplant_batch
{
    static class Program
    {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            string dbIp = "192.168.10.152";
            string dbId = "erp";
            string dbPw = "itsp@7735";
            string localconnectionString = Setting(dbIp, dbId, dbPw, "smart_db_ir", "1616");
            ...
            services.AddSingleton<DbConnectionInfoProvider>(provider => new DbConnectionInfoProvider(proxyconnectionString, localconnectionString));
            ...
            services.AddTransient<DataSyncLog_OrderUpdate>(provider =>
                new DataSyncLog_OrderUpdate(provider.GetRequiredService<Logger>(), provider.GetRequiredService<DbConnectionInfoProvider>()));
