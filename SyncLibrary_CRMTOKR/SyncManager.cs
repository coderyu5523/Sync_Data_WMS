    ...
    public class SyncManager
    {
        ...
        public async Task StartSync()
        {
            ...
            try
            {
                ...
                //_logger.LogInformation("동기화 작업이 시작되었습니다.");
                ...
                //_logger.LogInformation("동기화 작업이 완료되었습니다.");
            }
            catch (Exception ex)
            {
                _logger.LogError($"SyncManager - Error during sync: {ex.Message}", ex.ToString());
                // 예외를 다시 던짐으로써 SyncJob에서 처리할 수 있게 함
                throw;
        ...
        //    // 로그 기록
        //    _logger.LogInformation($"동기화 주기가 '{interval}'로 설정되었습니다.");
        ...
        private void OnTimerElapsed(object sender, EventArgs e)
        {
            ...
            //    _dataSyncProcessor.Process
            //    Async().Wait();
            //    UpdateLog("주기적 동기화 작업이 시작되었습니다.");
            //    _logger.LogInformation("주기적 동기화 작업이 시작되었습니다.");
            //}
            //catch (Exception ex)
            //{
            //    _logger.LogError($"동기화 작업 중 오류 발생: {ex.Message}");
